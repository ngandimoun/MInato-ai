...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: never) {
      const params = {
        alpha: true,
        depth: false,
        stencil: false,
    ...
    function resizeDoubleFBO(
      target: { width: any; height: any; read: { texture: any; fbo: any; width: any; height: any; texelSizeX: number; texelSizeY: number; attach(id: any): any; }; write: { texture: any; fbo: any; width: any; height: any; texelSizeX: number; texelSizeY: number; attach(id: any): any; }; texelSizeX: number; texelSizeY: number; },
      w: number,
      h: number,
      internalFormat: any,
      format: any,

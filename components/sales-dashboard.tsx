...
export function SalesDashboard() {
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center py-8 h-full"> {/* h-full pour que le parent puisse passer une hauteur */}
  ...
  if (error) {
    return (
      <div className="text-center py-8 h-full"> {/* h-full pour que le parent puisse passer une hauteur */}
  ...
  return (
    ...
    // comme h-[500px] ou h-[calc(100vh-HeaderHeight)].
    ...
    <ScrollArea className="h-full w-full p-1"> 
      {/* Le div original avec space-y-6 et un padding interne */}
      ...
      </div> {/* Fin du div space-y-6 */}
    </ScrollArea> // Fin de ScrollArea
  );
}
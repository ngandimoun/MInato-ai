...
export const GAME_DATA: GameLibraryItem[] = [
  ...
  // NEW GAMES - SPORT GURU, LANGUAGE MASTER, PROGRAMMING, RETRO, STRATEGY THINKER
  {
    id: 'sport_guru',
    name: 'sport_guru',
    display_name: 'Sport Guru',
  ...
  {
    id: 'programming_challenge',
    name: 'programming_challenge',
    display_name: 'Programming Challenge',
  ...
  {
    id: 'strategy_thinker',
    name: 'strategy_thinker',
    display_name: 'Strategy Thinker',
